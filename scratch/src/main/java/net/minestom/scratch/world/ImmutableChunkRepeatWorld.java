...
public final class ImmutableChunkRepeatWorld {
    ...
    public ImmutableChunkRepeatWorld(DimensionType dimensionType) {
        ...
        Arrays.setAll(sections, i -> new Section(Palette.blocks(), Palette.biomes()));

        for (int i = 0; i < 7; i++) {
            sections[i].blocks.fill(1);
        }
    ...
    record Section(Palette blocks, Palette biomes) {
    }
}
