...
public final class Scratch {
    ...
    private final Instance instance = new Instance(new BlockHolder(ScratchRegistryTools.DIMENSION_REGISTRY, DimensionType.OVERWORLD));
    ...
    static final class Instance {
        ...
        public Instance(BlockHolder blockHolder) {
    ...
    final class Entity {
        ...
        void tick() {
            var worldBorder = new WorldBorder(5, 0, 0, 1, 300);
            PhysicsResult physicsResult = PhysicsUtils.simulateMovement(position, velocity, type.registry().boundingBox(),
                    worldBorder, instance.blockHolder, aerodynamics, false, true, onGround, false, null);
